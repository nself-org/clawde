// doc_ingest_handler.go — IngestDocURL handler (internal helper).
//
...
//             IngestDocURL is part of GatewayServiceServer (generated by protoc);
//             gatewayHandler delegates here via its ingestor field.
...
// docIngestHandler is the internal IngestDocURL implementation, delegated to
// by gatewayHandler.IngestDocURL. Not a separate gRPC service registration.
...
// NewDocIngestHandler builds a docIngestHandler from a KBIngestor.
func NewDocIngestHandler(ingestor *docs.KBIngestor, clientID string) *docIngestHandler {
	return &docIngestHandler{ingestor: ingestor, clientID: clientID}
}

// IngestDocURL delegates to docs.KBIngestor.IngestDocURL.
